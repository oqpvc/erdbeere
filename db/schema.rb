...
ActiveRecord::Schema.define(version: 20_170_417_213_115) do
  create_table 'atoms', force: :cascade do |t|
    ...
    t.index %w[stuff_w_props_type stuff_w_props_id], name: 'index_atoms_on_stuff_w_props_type_and_stuff_w_props_id'
  end
  ...
  create_table 'explanations', force: :cascade do |t|
    ...
    t.datetime 'created_at',       null: false
    t.datetime 'updated_at',       null: false
    t.index %w[explainable_type explainable_id], name: 'index_explanations_on_explainable_type_and_explainable_id'
  end
